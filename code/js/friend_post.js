$.ajax({
	...
	url: "http://datamanage.altervista.org/friend_post.php",
	...
	success: function(msg){
		...
		for(var i=0; i<dec.server_response.length; i++)
		{
			...
			friend = dec.server_response[i].friend;
