...
$response = array();
$nome = $_SESSION['friend'];

$sql = "SELECT nome, cognome FROM Utenti WHERE matricola = '$nome' OR piva = '$nome' ";
$con = mysqli_connect($host, $user, $password, $db);
$result_friend = mysqli_query($con, $sql);
$dati= mysqli_fetch_array($result_friend);

$friend = "<b>" . $dati[0] . " " . $dati[1] . "</b>";
...
while($row = mysqli_fetch_array($result)){
	...
	array_push($response, array("info"=>$info , "stamp"=>$stamp, "tipo"=>$tipo, "friend"=>$friend));
}
